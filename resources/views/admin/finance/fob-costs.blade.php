        ...
        <div class="card-body">
            ...
            @else
                <form method="POST" action="{{ route('admin.finance.fob-costs.store') }}" class="row g-3">
                    ...
                    <div class="col-md-2"><label class="form-label">Amount</label><input name="amount" type="number" min="0" step="0.0001" class="form-control" value="{{ old('amount', 0) }}" required></div>
