...
<div class="modal fade" id="openingModal"><div class="modal-dialog modal-lg"><form method="POST" action="{{ route('admin.inventory.store') }}" class="modal-content">@csrf
    ...
    <div class="modal-body"><div class="row g-3">
        ...
        <div class="col-md-3"><label class="form-label">Warehouse *</label><select name="warehouse_id" id="openingWarehouse" class="form-select" required onchange="filterOpeningLocations()"><option value="">Select</option>@foreach($warehouses as $warehouse)<option value="{{ $warehouse->id }}">{{ $warehouse->name }}</option>@endforeach</select></div>
